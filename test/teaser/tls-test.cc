...
TEST(TLSTest, TLSEstimate) {
  ...
  // One outlier
  {
    Eigen::RowVectorXf measurements(6);
    measurements << 0.5, 1, 0.6, 0.7, 1.2, 10;
    Eigen::RowVectorXf ranges(6);
